# Always Leave Table in ORDER <br><br><br>
...
BEGIN
	SELECT name, ID FROM Grades WHERE (Final > (0.25*(Midterm1+Midterm2)+0.5*Final)) AND (Final > (0.5*(Midterm1+Midterm2))) ORDER BY SUBSTRING(name, 1,3), ID;
END
```
