# Slithering in Strings <br><br><br>
...
- [input] string key
    ...
    The key to the permutation cipher. It is guaranteed to be a permutation of the [plaintext alphabet](https://en.wikipedia.org/wiki/Substitution_cipher).
